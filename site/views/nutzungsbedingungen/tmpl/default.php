...
<p><b>2. Vertragliche Zusicherungen und Verzichterkl&auml;rungen</b><br/>
  Die Website <?php echo $this->siteName; ?> steht Ihnen - soweit nicht anders vereinbart 
  - kostenlos zur Verf&uuml;gung. Die Betreiber &uuml;bernehmen keinerlei Gew&auml;hr f&uuml;r Richtigkeit 
  der enthaltenen Informationen, Verf&uuml;gbarkeit der Dienste, Verlust von auf <?php echo $this->siteName; ?> 
  ...
  an den Angeboten vornehmen, die in dieser Publikation beschrieben werden.</p>
<p><b>3. Meinungs&auml;u&szlig;erungen bei Kommentaren und im Forum</b><br/>
  ...
  Beitr&auml;ge &uuml;bernommen.</p>
<p><b>3a. Spezielle Bestimmungen f&uuml;r angemeldete Nutzer</b><br/>
  Mit der Anmeldung bei <?php echo $this->siteName; ?> erkl&auml;rt sich der Nutzer - nachfolgend 
...
<ul><li>1. Sich in Ihren Beitr&auml;gen jeglicher Beleidigungen, strafbarer Inhalte, Pornographie und grober Ausdrucksweise zu enthalten,</li><li>2. Die alleinige Verantwortung f&uuml;r die von ihnen eingestellten Inhalte zu tragen, Rechte Dritter (insbesondere Marken-, Urheber- und Pers&ouml;nlichkeitsrechte) nicht zu verletzen und die Betreiber von &raquo;<?php echo $this->siteName;?>&laquo; von durch ihre Beitr&auml;ge ausgel&ouml;sten Anspr&uuml;chen Dritter vollst&auml;ndig freizustellen.</li><li>3. Weder in Foren noch in Kommentaren Werbung irgendwelcher Art einzustellen oder Foren und Kommentare zu irgendeiner Art gewerblicher T&auml;tigkeit zu nutzen. Insbesondere gilt das f&uuml;r die Ver&ouml;ffentlichung von &raquo;0900&laquo;-Rufnummern zu irgendeinem Zweck.</li></ul>
<p>Es besteht keinerlei Anspruch auf Ver&ouml;ffentlichung von eingereichten Kommentaren 
  oder Forenbeitr&auml;gen. Die Betreiber von &raquo;<?php echo $this->siteName; ?>&laquo; behalten sich 
  ...
  zu l&ouml;schen.</p>
<p><b>4. Einreichen von Beitr&auml;gen und Artikeln</b><br/>
  Soweit das Mitglied von der M&ouml;glichkeit Gebrauch macht, eigene Beitr&auml;ge f&uuml;r 
  redaktionellen Teil von &raquo;<?php echo $this->siteName; ?>&laquo; einzureichen, gilt Folgendes:<br />
  Voraussetzung f&uuml;r das Posten eigener Beitr&auml;ge ist, dass das Mitglied seinen 
  vollst&auml;ndigen und korrekten Vor- und Nachnamen in sein &raquo;<?php echo $this->siteName; ?>&laquo; 
...
<p><b>Rechtswirksamkeit</b><br/>
  Diese Allgemeinen Nutzungsbedingungen beziehen sich auf <?php echo $this->siteName; ?>.<br />
