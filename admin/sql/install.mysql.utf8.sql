...
CREATE  TABLE IF NOT EXISTS `#__imprint_imprints` (
  ...
  `bank_name2` VARCHAR(255) NOT NULL DEFAULT '' ,
  `account_number2` VARCHAR(255) NOT NULL DEFAULT '' ,
  ...
  `account_number3` VARCHAR(255) NOT NULL DEFAULT '' ,
  ...
  `account_number4` VARCHAR(255) NOT NULL DEFAULT '' ,
  ...
  `responsible_for_content_mail` VARCHAR(255) NOT NULL DEFAULT '' ,
  ...
  `sales_tax_id2` VARCHAR(255) NOT NULL DEFAULT '' ,
  `economic_id2` VARCHAR(255) NOT NULL DEFAULT '' ,
  `responsible_for_content2` VARCHAR(255) NOT NULL DEFAULT '' ,
  `responsible_for_content_mail2` VARCHAR(255) NOT NULL DEFAULT '' ,
  ...
  `template_creator_website` VARCHAR(255) NOT NULL DEFAULT '' ,
