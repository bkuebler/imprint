...
ALTER TABLE `#__imprint_imprints` CHANGE `kontonr` `account_number` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
ALTER TABLE `#__imprint_imprints` CHANGE `bankinhaber2` `account_holder2` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
...
ALTER TABLE `#__imprint_imprints` CHANGE `kontonr2` `account_number2` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
ALTER TABLE `#__imprint_imprints` CHANGE `bankinhaber3` `account_holder3` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
...
ALTER TABLE `#__imprint_imprints` CHANGE `kontonr3` `account_number3` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
ALTER TABLE `#__imprint_imprints` CHANGE `bankinhaber4` `account_holder4` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
...
ALTER TABLE `#__imprint_imprints` CHANGE `kontonr4` `account_number4` VARCHAR( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' ;
