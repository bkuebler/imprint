		...
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible">
					<?php echo JText::_('COM_IMPRINT_SEARCH_IN_TITLE'); ?>
				</label>
				<input type="text" name="filter_search" id="filter_search" 
					placeholder="<?php echo JText::_('COM_IMPRINT_SEARCH_IN_TITLE'); ?>"
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
					title="<?php echo JText::_('COM_IMPRINT_SEARCH_IN_TITLE'); ?>" />
			</div>
			...
			<div class="btn-group pull-right hidden-phone">
				...
				<select name="directionTable" id="directionTable" class="input-medium" onchange="Joomla.orderTable()">
					...
					<option value="asc" <?php echo $ascSelect; ?>>
						<?php echo JText::_('JGLOBAL_ORDER_ASCENDING');?>
					</option>
					<option value="desc" <?php echo $descSelect; ?>>
