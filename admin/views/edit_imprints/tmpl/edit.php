...
?>
<form action="<?php echo JRoute::_('index.php?option=com_impressum&view=edit_imprints&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="impressum-form" class="form-validate">
