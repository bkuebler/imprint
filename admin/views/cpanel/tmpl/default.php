...
<table class="adminform">
	<tr>
		...
		<td width="45%" valign="top">
			...
			<br />
			<a href="https://github.com/joomla-imprint" target="_blank"><?php echo JText::_('COM_IMPRINT_HOME');?></a><br />
			<?php echo JHTML::_('email.cloak', "dev-team-imprint@joomla.bksus.de"); ?></p>
