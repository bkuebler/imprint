		...
		<div class="adminform">
			...
			<div class="imprint-cpanel-right">
				<div class="well">
					...
					<p><?php echo JText::_('COM_IMPRINT_LICENCE'); ?>: <a href="http://www.gnu.org/licenses/gpl-2.0.html" target="_blank">GPLv2</a></p>
					...
					<h3><?php echo JText::_('COM_IMPRINT_DOCUMENTATION_CONTRIBUTERS');?>:</h3>
					<p>
					...
					<p>
						...
						<?php echo JText::_('COM_IMPRINT_LICENCE'); ?>: <a href="http://www.gnu.org/licenses/gpl-1.0.html" target="_blank">GPL</a><br />
						Impressum (C) 2007 - 2009 <a href="http://www.gcsoft.de" target="_blank">Gerhard Clausen</a>, \
						<?php echo JText::_('COM_IMPRINT_LICENCE');?>: <a href="http://www.gnu.org/licenses/gpl-1.0.html" target="_blank">GPL</a>
					</p>
				</div>
			</div>
		</div>
